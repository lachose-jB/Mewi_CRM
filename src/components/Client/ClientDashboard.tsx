...
const DebiteurDashboard: React.FC = () => {
  ...
  const statusConfig = getStatusConfig(debiteurData.status);
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Bonjour {debiteurData.name}, voici l'état de votre dossier</p>
        </div>
        <button 
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <div className="flex items-center space-x-3">
                <h2 className="text-xl font-bold text-gray-900">Dossier #{debiteurData.id.substring(0, 8)}</h2>
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${statusConfig.color}`}>
                  {statusConfig.label}
                </span>
              </div>
              <p className="text-gray-600">{statusConfig.description || (
                debiteurData.status === 'blue' ? 'Votre dossier est à jour' :
                debiteurData.status === 'yellow' ? 'Une relance a été envoyée' :
                debiteurData.status === 'orange' ? 'Règlement requis rapidement' :
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{debiteurInvoices.length}</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            {debiteurInvoices.filter((invoice: any) => invoice.status !== 'paid').slice(0, 3).map((invoice: any) => (
            ...
            {debiteurInvoices.filter((invoice: any) => invoice.status !== 'paid').length === 0 && (
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            {debiteurCommunications.slice(0, 3).map((comm: any) => {
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {debiteurInvoices.filter((invoice: any) => invoice.status === 'pending' || invoice.status === 'partial').length === 0 && (
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{debiteurData.email}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{debiteurData.phone || 'Non renseigné'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{debiteurData.contactName || debiteurData.name}</p>
                  {debiteurData.contactRole && (
                    <p className="text-sm text-gray-500">{debiteurData.contactRole}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{new Date(debiteurData.created_at).toLocaleDateString('fr-FR')}</p>
                </div>
              </div>
...
export default DebiteurDashboard;